...
const ZeroMatrix = new Matrix({ numRows: 3, numCols: 3 });
const ColumnMatrix = new Matrix({ numRows: 3, numCols: 1, matrix: [[1], [2], [3]] });
const RowMatrix = new Matrix({ numRows: 1, numCols: 3, matrix: [[1, 2, 3]] });
const SquareMatrix = new Matrix({ numRows: 3, numCols: 3, matrix: [[1, 8, 1], [7, 2, 0], [5, 0, 3]] });
const DiagonalMatrix = new Matrix({ numRows: 3, numCols: 3, matrix: [[1, 0, 0], [0, 4, 0], [0, 0, 7]] });
const IdentityMatrix = new Matrix({ numRows: 2, numCols: 2, matrix: [[1, 0], [0, 1]] });
...
describe('Matrix utils', () => {
    ...
    describe('transpose', () => {
        ...
        it('Should transpose a matrix', () => {
            ...
            const transposeTheTranspose = new Matrix(
